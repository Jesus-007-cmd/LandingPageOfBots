...
const SuiteBotsSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Carrusel */}
      <motion.div variants={item} className="relative max-w-screen-lg mx-auto">
        <button
          onClick={scrollPrev}
          className="absolute left-0 top-1/2 transform -translate-y-1/2 z-20 p-3 bg-gradient-to-br from-indigo-500 to-blue-500 rounded-full shadow-lg hover:from-indigo-600 hover:to-blue-600 transition"
        >
          ...
          <div className="flex snap-x snap-mandatory scroll-smooth">
            {sections.map((sec, idx) => {
              ...
              return (
                ...
                >
                  <div
                    className={`flex flex-col lg:flex-row items-center gap-6 p-6 rounded-3xl shadow-2xl min-h-[320px]
                      ${idx % 2 === 0
                  ...
                  >
                    ...
                    <motion.img
                      ...
                      className="flex-1 w-full max-w-sm h-64 object-cover rounded-2xl border-4 border-blue-500 shadow-2xl"
                    />
                  </div>
                </motion.div>
              );
        ...
        <button
          onClick={scrollNext}
          className="absolute right-0 top-1/2 transform -translate-y-1/2 z-20 p-3 bg-gradient-to-br from-indigo-500 to-blue-500 rounded-full shadow-lg hover:from-indigo-600 hover:to-blue-600 transition"
        >
